...
- [palera1n](https://github.com/palera1n/palera1n) will never work in VirtualBox, VMware or any virtual machine that doesn't support a PCI passthrough. If you receive a `Segmentation Fault` that's on you.
...
- [Everyone else who contributed to palen1x](https://github.com/palera1n/palen1x/graphs/contributors) & [palera1n](https://github.com/palera1n/palera1n/graphs/contributors)
